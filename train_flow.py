    ...
    for epoch in range(start_epoch, opt.nEpochs):
        ...
        if (epoch + 1) % opt.vizEpoch == 0 and should_diag:
            ...
            with torch.no_grad():
                ...
                x_gen_eval = model.gen_samples((25, *x.shape[1:]), x.device, clip_denoised=False)
                x_gen_list = model.gen_sample_traj((1, *x.shape[1:]), x.device, freq=40, clip_denoised=False)
            ...
            visualize_pointcloud_batch('%s/epoch_%03d_x.png' % (outf_syn, epoch), 
